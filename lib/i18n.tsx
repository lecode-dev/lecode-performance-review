...
const EN: Record<string, string> = {
  ...
  // ---- questions ----
  "Escreve código legível, bem estruturado e seguindo padrões de boas práticas (SOLID, Clean Code, convenções do projeto).": "Writes readable, well-structured code following best practices (SOLID, Clean Code, project conventions).",
  "Demonstra domínio da stack utilizada no projeto, entendendo impactos técnicos das decisões e propondo melhorias quando apropriado.": "Demonstrates command of the project's stack, understands the technical impact of decisions, and proposes improvements when appropriate.",
  "Resolve problemas técnicos de forma eficiente, aplicando lógica de programação adequada e considerando performance e escalabilidade.": "Solves technical problems efficiently, applying sound programming logic and considering performance and scalability.",
  "Busca ativamente aprender novas tecnologias, acompanha tendências do mercado e aplica conhecimentos adquiridos no dia a dia.": "Actively seeks to learn new technologies, follows market trends, and applies acquired knowledge day to day.",
  "Contribui ativamente para a qualidade do projeto através de code reviews construtivos, testes automatizados e refatorações.": "Actively contributes to project quality through constructive code reviews, automated tests, and refactoring.",
  "Cumpre prazos acordados de forma consistente, comunicando proativamente quando identifica riscos ou impedimentos.": "Consistently meets agreed deadlines, proactively communicating when they identify risks or blockers.",
  "Entrega funcionalidades completas, testadas e com baixo índice de bugs, atendendo aos critérios de aceitação definidos.": "Delivers complete, tested features with a low bug rate, meeting the defined acceptance criteria.",
  "Mantém produtividade adequada ao seu nível, demonstrando evolução na velocidade e qualidade das entregas ao longo do tempo.": "Maintains productivity appropriate to their level, demonstrating improvement in speed and quality of delivery over time.",
  "Demonstra comprometimento com os objetivos do projeto e da equipe, priorizando entregas de valor para o produto.": "Shows commitment to the project's and team's objectives, prioritizing high-value deliveries for the product.",
  "Mantém desempenho consistente ao longo do tempo, sem oscilações significativas de qualidade ou produtividade.": "Maintains consistent performance over time, without significant swings in quality or productivity.",
  "Comunica-se de forma clara e objetiva, adaptando a linguagem ao público (técnico ou não-técnico) e contexto da situação.": "Communicates clearly and objectively, adapting language to the audience (technical or non-technical) and situational context.",
  "Reporta proativamente o status das tarefas, antecipa riscos e comunica impedimentos antes que se tornem problemas críticos.": "Proactively reports task status, anticipates risks, and flags blockers before they become critical issues.",
  "Recebe feedback de forma construtiva, demonstra abertura para críticas e implementa melhorias sugeridas.": "Receives feedback constructively, shows openness to criticism, and implements suggested improvements.",
  "Produz documentação técnica clara e útil (READMEs, comentários no código, wikis), facilitando a manutenção e onboarding.": "Produces clear, useful technical documentation (READMEs, code comments, wikis), easing maintenance and onboarding.",
  "Participa ativamente de reuniões, contribuindo com ideias relevantes, fazendo perguntas pertinentes e respeitando o tempo dos demais.": "Actively participates in meetings, contributing relevant ideas, asking pertinent questions, and respecting others' time.",
  "Trabalha bem em equipe, compartilhando conhecimento, participando de pair programming e contribuindo para o sucesso coletivo.": "Works well in a team, shares knowledge, participates in pair programming, and contributes to collective success.",
  "Demonstra disposição genuína para ajudar colegas, oferecendo suporte técnico e mentoria quando solicitado ou quando percebe necessidade.": "Shows genuine willingness to help colleagues, offering technical support and mentoring when asked or when they notice a need.",
  "Mantém atitude positiva e construtiva mesmo em situações desafiadoras, evitando comportamentos que prejudiquem o clima da equipe.": "Keeps a positive, constructive attitude even in challenging situations, avoiding behaviors that harm team morale.",
  "Respeita decisões técnicas do time mesmo quando discorda, expressando opiniões de forma profissional e acatando o consenso.": "Respects the team's technical decisions even when disagreeing, expressing opinions professionally and accepting consensus.",
  "Contribui ativamente para um ambiente de trabalho saudável, inclusivo e psicologicamente seguro para todos os membros.": "Actively contributes to a healthy, inclusive, and psychologically safe work environment for all members.",
  "Trabalha de forma independente no nível esperado para seu cargo, buscando ajuda apenas quando realmente necessário.": "Works independently at the level expected for their role, seeking help only when truly necessary.",
  "Identifica e resolve problemas proativamente, sem esperar que sejam reportados ou que alguém solicite a correção.": "Identifies and resolves problems proactively, without waiting for them to be reported or for someone to request a fix.",
  "Propõe melhorias técnicas, de processo ou de produto de forma embasada, com argumentos claros sobre benefícios e impactos.": "Proposes technical, process, or product improvements in a well-founded way, with clear arguments about benefits and impact.",
  "Voluntaria-se para assumir responsabilidades e desafios além do escopo básico, demonstrando interesse em crescer.": "Volunteers to take on responsibilities and challenges beyond the basic scope, showing interest in growing.",
  "Gerencia bem seu tempo e tarefas, mantendo organização pessoal e cumprindo compromissos sem necessidade de microgerenciamento.": "Manages time and tasks well, staying personally organized and meeting commitments without the need for micromanagement.",
...
const ES: Record<string, string> = {
  ...
  // ---- questions ----
  "Escreve código legível, bem estruturado e seguindo padrões de boas práticas (SOLID, Clean Code, convenções do projeto).": "Escribe código legible, bien estructurado y siguiendo buenas prácticas del proyecto (SOLID, Clean Code, convenciones del proyecto).",
  "Demonstra domínio da stack utilizada no projeto, entendendo impactos técnicos das decisões e propondo melhorias quando apropriado.": "Demuestra dominio del stack utilizado en el proyecto, entiende el impacto técnico de las decisiones y propone mejoras cuando corresponde.",
  "Resolve problemas técnicos de forma eficiente, aplicando lógica de programação adequada e considerando performance e escalabilidade.": "Resuelve problemas técnicos de forma eficiente, aplicando lógica de programación adecuada y considerando el rendimiento y la escalabilidad.",
  "Busca ativamente aprender novas tecnologias, acompanha tendências do mercado e aplica conhecimentos adquiridos no dia a dia.": "Busca activamente aprender nuevas tecnologías, sigue las tendencias del mercado y aplica los conocimientos adquiridos en el día a día.",
  "Contribui ativamente para a qualidade do projeto através de code reviews construtivos, testes automatizados e refatorações.": "Contribuye activamente a la calidad del proyecto mediante code reviews constructivos, pruebas automatizadas y refactorizaciones.",
  "Cumpre prazos acordados de forma consistente, comunicando proativamente quando identifica riscos ou impedimentos.": "Cumple los plazos acordados de forma consistente, comunicando proactivamente cuando identifica riesgos o impedimentos.",
  "Entrega funcionalidades completas, testadas e com baixo índice de bugs, atendendo aos critérios de aceitação definidos.": "Entrega funcionalidades completas, probadas y con baja tasa de errores, cumpliendo los criterios de aceptación definidos.",
  "Mantém produtividade adequada ao seu nível, demonstrando evolução na velocidade e qualidade das entregas ao longo do tempo.": "Mantiene una productividad acorde a su nivel, demostrando evolución en velocidad y calidad de las entregas a lo largo del tiempo.",
  "Demonstra comprometimento com os objetivos do projeto e da equipe, priorizando entregas de valor para o produto.": "Demuestra compromiso con los objetivos del proyecto y del equipo, priorizando entregas de valor para el producto.",
  "Mantém desempenho consistente ao longo do tempo, sem oscilações significativas de qualidade ou produtividade.": "Mantiene un desempeño consistente a lo largo del tiempo, sin variaciones significativas de calidad o productividad.",
  "Comunica-se de forma clara e objetiva, adaptando a linguagem ao público (técnico ou não-técnico) e contexto da situação.": "Se comunica de forma clara y objetiva, adaptando el lenguaje al público (técnico o no técnico) y al contexto de la situación.",
  "Reporta proativamente o status das tarefas, antecipa riscos e comunica impedimentos antes que se tornem problemas críticos.": "Reporta proactivamente el estado de las tareas, anticipa riesgos y comunica impedimentos antes de que se vuelvan problemas críticos.",
  "Recebe feedback de forma construtiva, demonstra abertura para críticas e implementa melhorias sugeridas.": "Recibe el feedback de forma constructiva, muestra apertura a la crítica e implementa las mejoras sugeridas.",
  "Produz documentação técnica clara e útil (READMEs, comentários no código, wikis), facilitando a manutenção e onboarding.": "Produce documentación técnica clara y útil (READMEs, comentarios en el código, wikis), facilitando el mantenimiento y el onboarding.",
  "Participa ativamente de reuniões, contribuindo com ideias relevantes, fazendo perguntas pertinentes e respeitando o tempo dos demais.": "Participa activamente en reuniones, aportando ideas relevantes, haciendo preguntas pertinentes y respetando el tiempo de los demás.",
  "Trabalha bem em equipe, compartilhando conhecimento, participando de pair programming e contribuindo para o sucesso coletivo.": "Trabaja bien en equipo, comparte conocimiento, participa en pair programming y contribuye al éxito colectivo.",
  "Demonstra disposição genuína para ajudar colegas, oferecendo suporte técnico e mentoria quando solicitado ou quando percebe necessidade.": "Muestra disposición genuina para ayudar a colegas, ofreciendo soporte técnico y mentoría cuando se le solicita o cuando percibe la necesidad.",
  "Mantém atitude positiva e construtiva mesmo em situações desafiadoras, evitando comportamentos que prejudiquem o clima da equipe.": "Mantiene una actitud positiva y constructiva incluso en situaciones difíciles, evitando comportamientos que afecten el clima del equipo.",
  "Respeita decisões técnicas do time mesmo quando discorda, expressando opiniões de forma profissional e acatando o consenso.": "Respeta las decisiones técnicas del equipo aun cuando no está de acuerdo, expresando opiniones de forma profesional y aceptando el consenso.",
  "Contribui ativamente para um ambiente de trabalho saudável, inclusivo e psicologicamente seguro para todos os membros.": "Contribuye activamente a un entorno de trabajo sano, inclusivo y psicológicamente seguro para todos los miembros.",
  "Trabalha de forma independente no nível esperado para seu cargo, buscando ajuda apenas quando realmente necessário.": "Trabaja de forma independiente al nivel esperado para su puesto, buscando ayuda solo cuando realmente es necesario.",
  "Identifica e resolve problemas proativamente, sem esperar que sejam reportados ou que alguém solicite a correção.": "Identifica y resuelve problemas proactivamente, sin esperar a que sean reportados o a que alguien solicite la corrección.",
  "Propõe melhorias técnicas, de processo ou de produto de forma embasada, com argumentos claros sobre benefícios e impactos.": "Propone mejoras técnicas, de proceso o de producto de forma fundamentada, con argumentos claros sobre beneficios e impactos.",
  "Voluntaria-se para assumir responsabilidades e desafios além do escopo básico, demonstrando interesse em crescer.": "Se ofrece para asumir responsabilidades y desafíos más allá del alcance básico, mostrando interés en crecer.",
  "Gerencia bem seu tempo e tarefas, mantendo organização pessoal e cumprindo compromissos sem necessidade de microgerenciamento.": "Gestiona bien su tiempo y sus tareas, mantiene organización personal y cumple compromisos sin necesidad de microgestión.",
