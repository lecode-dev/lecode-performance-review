...
// Constantes de domínio + helpers de score. Espelha design/store.jsx.
// Fonte única para UI e cálculos no cliente (o backend recalcula via views/RPC).
// =============================================================================

import type { DimensionKey, ReviewComments } from './database.types';
...
export const OPEN_QUESTIONS: { key: keyof ReviewComments; label: string; hint: string }[] = [
...
/** Pesos canônicos (também vivem em form_versions). */
...
/** Score final ponderado. Use só para preview no cliente; o servidor é a verdade. */
